...
class DriverTheme {
  ...
  static ThemeData get lightTheme {
    final colors = DriverThemeColors.light;
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        prefixIconColor: WidgetStateColor.resolveWith((states) {
          if (states.contains(WidgetState.focused)) return colors.textPrimary;
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: GoogleFonts.inter(color: colors.textOnDark, fontSize: 14),
        elevation: 4,
      ),
  ...
  static ThemeData get darkTheme {
    final colors = DriverThemeColors.dark;
